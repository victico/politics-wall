...
(function () {
  ...
  var revenueGeneratedEl = document.querySelector('#revenueGenerated'),
  ...
  if (_typeof(revenueGeneratedEl) !== undefined && revenueGeneratedEl !== null) {
  ...
  var weeklyEarningReportsEl = document.querySelector('#weeklyEarningReports'),
  ...
  if (_typeof(weeklyEarningReportsEl) !== undefined && weeklyEarningReportsEl !== null) {
    var weeklyEarningReports = new ApexCharts(weeklyEarningReportsEl, weeklyEarningReportsConfig);
    weeklyEarningReports.render();
  } // Support Tracker - Radial Bar Chart
  // --------------------------------------------------------------------


  var supportTrackerEl = document.querySelector('#supportTracker'),
  ...
  if (_typeof(supportTrackerEl) !== undefined && supportTrackerEl !== null) {
    var supportTracker = new ApexCharts(supportTrackerEl, supportTrackerOptions);
    supportTracker.render();
  } // Total Earning Chart - Bar Chart
  // --------------------------------------------------------------------


  var totalEarningChartEl = document.querySelector('#totalEarningChart'),
  ...
  if (_typeof(totalEarningChartEl) !== undefined && totalEarningChartEl !== null) {
    var totalEarningChart = new ApexCharts(totalEarningChartEl, totalEarningChartOptions);
    ...
    var dt_project = dt_projects_table.DataTable({
      ...
      columnDefs: [{
        ...
        render: function render(data, type, full, meta) {
          ...
          var $row_output = '<div class="d-flex justify-content-left align-items-center">' + '<div class="avatar-wrapper">' + '<div class="avatar me-2">' + $output + '</div>' + '</div>' + '<div class="d-flex flex-column">' + '<span class="text-truncate fw-semibold">' + $name + '</span>' + '<small class="text-truncate text-muted">' + $date + '</small>' + '</div>' + '</div>';
          return $row_output;
        }
      }, {
        // Teams
