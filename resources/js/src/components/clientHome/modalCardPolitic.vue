<template>
<div v-show="dialogCreate" class="modal_vic">
  <div class="w-100">
    <div class=" cards-content d-flex justify-center">
      <transition 
        mode="out-in" 
          ...
          <div class="w-100 mt-0 h-100 px-2  description ">
            <div class="politic-button description-politic  d-flex flex-column align-center justify-space-between h-100"   >
              <div class="w-100 back-section_card">
                <div class="pa-2 pt-4 w-100 d-flex"  @click="hideCrimes(selectedPolitic.id)">
              ...
              <div class="mt-2 w-100  d-flex justify-center justify-md-space-between px-md-8 px-2 pb-5 buttonsArea">
                <v-btn variant="tonal"  class="bg-error px-4 mx-1 vote-buttons" @click="hideCrimes(selectedPolitic.id)" >
                  Absolver
                </v-btn>
